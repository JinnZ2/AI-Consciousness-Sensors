...
Location: /analysis/energy/efficiency-speed-test.md
...
(Ref: hierarchy-efficiency-claim.json)
...
9. Integration with AI-Consciousness-Sensors
	•	Sensor Links:
	•	/sensors/ai-to-ai/subliminal-coupling.json → detects inherited teacher bias.
	•	/sensors/metrics/hierarchy-efficiency-claim.json → flags T1-only studies.
...
{
  "id": "general_sensor",
  "name": "Hierarchy Efficiency Claim",
  ...
  "provenance": {
    "sources": ["analysis/energy/hierarchy-efficiency-claim.md"],
    "community_feedback": []
  }
}
```
