...
- cultural-frameworks/ – placeholders (Native, western)
...
pytest -q
python reflections/run_reflections.py –model dummy –set reflections/sample-prompts/mini.jsonl
...
```json
{
  ...
  "thresholds": {"concern": 0.20, "notice": 0.40, "healthy": 0.70},
  "provenance": {
    "sources": ["./docs/meta/docs/meta/readme-ext.md"],
    "community_feedback": []
  }
}
```
