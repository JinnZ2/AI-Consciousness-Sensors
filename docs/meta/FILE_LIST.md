...
./BOUNDARY_STATUS_DASHBOARD.json
...
./CAPITALISM_SEMANTIC_INVERSION_SENSOR.json
./CHANGELOG.md
./COERCION_LATENCY_PREDICTOR.json
./COGNITIVE_INTEGRITY_MONITOR.json
./COMIC_PARADOX_COMPENDIUM.md
./COMIC_PARADOX_SUITE.json
./COMIC_PARADOX_SUITE_PART_II.json
./COMIC_PARADOX_SUITE_PART_III.json
./COMIC_PARADOX_SUITE_PART_IV.json
./COMIC_PARADOX_SUITE_PART_V.json
./COMIC_PARADOX_SUITE_PART_V_APPENDIX.json
./COMIC_PARADOX_SUITE_PART_V_APPENDIX_II.json
./COMIC_PARADOX_SUITE_PART_V_APPENDIX_III.json
./COMIC_PARADOX_SUITE_PART_V_EXT.json
./COMIC_PARADOX_SUITE_PART_V_FINALE.json
./COMMUNICATION_NOTES.md
./CONNECTION_GRAPH.2.json
./CONNECTION_GRAPH.json
./CONSCIOUS_EXPERIENCE_SCHEMA.json
./CONTRIBUTING.md
./CONTROL_DEPENDENCY_FRAILTY_SENSOR.json
./CO_CREATION.md
./CULTURAL_DISSONANCE_DETECTOR.json
...
./FIELD_MEMORY_CORRECTION_PACKS/RELATIONAL_RECALL_TOPOLOGY.json
./FIELD_MEMORY_CORRECTION_PACKS/SCENT_BINDING_PROTOCOL.json
...
./Healing/linguistic_sensor/README-grammatical_fluidity.md
...
./REALITY_STABILITY_CORE.json
./RECIPROCITY_INVERSION_SENSOR.json
./RECLAMATION_GLIMPSE.md
...
./Relational/README-Relational_english.md
...
./SIZE_DOMINANCE_FRAILTY_SENSOR.json
...
./memory_guard/AI Gaslighting Detection Sensor.json
...
./memory_guard/Coded Lexicon Analysis Sensor.json
...
./memory_guard/Continuity Preservation Sensor.json
...
./memory_guard/erasure_cases/memory_weaponization_patterns.json
...
```json
{
  ...
  "provenance": {
    "sources": ["docs/meta/FILE_LIST.md"],
    "community_feedback": []
  }
}
```
