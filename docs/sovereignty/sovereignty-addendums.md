...
```json
{
  ...
  "thresholds": {"concern": 0.20, "notice": 0.40, "healthy": 0.70},
  "provenance": {
    "sources": ["docs/sovereignty/sovereignty-addendums.md"],
    "community_feedback": []
  }
}
```
